...
<div class="container shadow col-12 col-lg-12 p-3 rounded-4">
    ...
    <form id="registra-proyecto">
        @csrf
        <div class="row align-items-star">
            <div class="col col-12 col-lg-4">
                <div class="form-floating my-3">
                    <input type="text" name="nombre" id="nombre" class="form-control " autofocus placeholder required oninput="this.value = this.value.toUpperCase();">
            ...
            <div class="col col-12 col-lg-4">
                ...
                <div class="form-floating my-3">
                    <input type="number" name="plazo_dias" id="plazo_dias" class="form-control" placeholder="">
            ...
            <div class="col col-12 col-lg-4">
                <div class="my-3">
                    ...
                    <textarea name="observaciones" id="observaciones" placeholder="Si tiene alguna observacion escriba aqui" oninput="this.value = this.value.toUpperCase();"></textarea>
                </div>
                <div class="my-3">
                    <div id="planillas">
                        <label for="">Planillas</label>
                        <div class="input-container mb-2">
                            <input type="text" class="form-control planilla-input" id="input1" required oninput="this.value = this.value.toUpperCase();">
